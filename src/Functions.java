...
//   public static final int PLAYER_NUM_PROPERTIES = 0;
...
////   public static final int BGND_ROW = 3;
   ...
   */
      ...
      ImageStore imageStore)
   {
      ...
      {
         MonsterFactory m = new MonsterFactory(properties[PROPERTY_KEY], properties, world, imageStore);
         return m.parse();
...
//         case OCTO_KEY:
//            return VirtualWorld.parsePlayer(properties, world, imageStore);
//         case OBSTACLE_KEY:
//            return VirtualWorld.parseObstacle(properties, world, imageStore);
//         case FISH_KEY:
//            return VirtualWorld.parseGaoga(properties, world, imageStore);
//         case ATLANTIS_KEY:
//            return VirtualWorld.parseMugen(properties, world, imageStore);
//         case SGRASS_KEY:
//            return VirtualWorld.parseSgrass(properties, world, imageStore);
//         }
      }
