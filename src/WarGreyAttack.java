...
public class WarGreyAttack extends MonsterAnimation {

    public WarGreyAttack(String id, Point position, List<PImage> images, int imageIndex, int resourceLimit, int health, int actionPeriod, int animationPeriod) throws IOException {
        super(id, position, images, imageIndex, resourceLimit, health, actionPeriod, animationPeriod);

        List<PImage> i = new ArrayList<PImage>();
        try {
            BufferedImage b = ImageIO.read(new File("images/wargreyattack0.png"));
            ...
            b = ImageIO.read(new File("images/wargreyattack1.png"));
